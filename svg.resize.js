    ...
    SVG.extend(SVG.Element, {
        ...
        resize: function(options) {
            ...
            resize = function(event){
                ...
                element.startParams = {
                    x: event.detail.x,      // x-position of the mouse when resizing startet
                    y: event.detail.y,      // y-position of the mouse when resizing startet
                    box: element.bbox(),    // The bounding-box of the element
                    rbox: element.rbox(),   // The "real"-bounding box (transformations included)
                    rotation: element.transform().rotation  // The curren rotation of the element
                };
                ...
                // When resizing startet, we have to register events for...
            ...
            // The update-function redraws the element everytime the mouse is moving
            ...
            // We listen to all these events which are specifying differnt edges
